...
<div id="ww">
   <div class="container pt">
      ...
      <br>		
      <form method="post" action="cadastrar_jogo.php" enctype="multipart/form-data">
         <table id="cad_table">
            <tr>            
            ...
            <tr>            
               <td><input type="text" name="endereco" id="descricao" class="txt" placeholder="Endereço"/>
               </td>
            </tr>
            <tr>
               <td>Foto:            
