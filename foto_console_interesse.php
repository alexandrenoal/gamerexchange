   ...
   <div class="row">
      <div class="col-lg-8 col-lg-offset-2 centered">
         <br><br>
            <?php
            $foto = $_GET['foto'];
            echo "<img src= 'img/$foto' width='900' height='700' style='border-radius:0px; border:px solid #ddd'><br /><br />";
            ?>	
            <?php
            $usuario = $_GET['usuario'];
            $foto = $_GET['foto'];

            $selbanco = "SELECT * FROM vitrine_interesse_console WHERE '$usuario' = usuario && '$foto' = foto";
