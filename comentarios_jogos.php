   ...
   <div class="container">
      <div class="row">
         <div class="col-lg-8 col-lg-offset-2 centered">
            ...
            <td>
               <h2><a href="postagem_jogo.php">Postagens Jogos</a></p><br></h2>
            </td>
            <?php $usuario = $_GET['usuario'];?>
            <?php $foto = $_GET['foto'];?>
            <?php
               $foto = $_GET['foto'];
               echo "<img src= 'img/$foto' width='400' height='500' style='border-radius:0px; border:5px solid #ddd'><br /><br />";
               ?>	
            <form method="post" action="cadastrar_comentarios_jogos.php" enctype="multipart/form-data">												
            ...
            <?php
               ...
               $foto = $_GET['foto'];
               $selbanco = "SELECT * FROM comentarios_jogos WHERE '$usuario' = usuario && '$foto' = foto ";
