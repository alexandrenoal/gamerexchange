...
<div class="container">
   <div class="row">
      <div class="col-lg-8 col-lg-offset-2 centered">
         <h2><?php echo "Encontrar interessados!<br>"?></h2>
         <br>
         <div aling="center" id="busca">
            <form action"procurar_interesse.php" enctype="multipart/form-data" name="busca" method="post">
               <input type="text" name="buscar"/>
               <input type="submit" name="enviar" class="btn" value="Procurar game" /><br><br><br>
               <?php	
                  $buscar_jogo = $_POST['buscar'];
                  $resultado = "SELECT * FROM vitrine_interesse_console WHERE nome LIKE '%$buscar_jogo%'";									
